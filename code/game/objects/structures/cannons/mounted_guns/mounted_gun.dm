...
/obj/structure/mounted_gun
	...
	///Accepted "ammo" type
	var/obj/item/ammo_type = /obj/item/ammo_casing/a762
	///Alternative ammo types, for extra effects!
	var/obj/item/alt_ammo_type = /obj/item/ammo_casing/a762
	...
	var/obj/projectile/projectile_type = /obj/projectile/bullet/a762
	///Projectile from said gun. Doesnt automatically inherit said ammo's projectile in case you wanted to make a gun that shoots floor tiles or something.
	var/obj/projectile/alt_projectile_type = /obj/projectile/bullet/a762
