/obj/item/gun/ballistic/rifle
	...
	icon = 'surfshack13/icons/mosin_nagant/mosinnagant.dmi'
	icon_state = "moistnugget"
	lefthand_file = 'surfshack13/icons/mosin_nagant/mosin_lefthand.dmi'
	righthand_file = 'surfshack13/icons/mosin_nagant/mosin_righthand.dmi'
...
/obj/item/gun/ballistic/rifle/boltaction/add_bayonet_point()
	AddComponent(/datum/component/bayonet_attachable, offset_x = 37, offset_y = 14)
